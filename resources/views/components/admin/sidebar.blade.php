<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
    <div class="position-sticky pt-3">
        <ul class="nav flex-column">
            <li class="nav-item">
                <a class="nav-link {{request()->routeIs('admin') ? 'active' : 'text-secondary'}}" aria-current="page"
                   href="{{route('admin')}}">
            ...
            <li class="nav-item">
                <a class="nav-link {{request()->routeIs('projects.index') ? 'active' : 'text-secondary'}} "
            ...
            <li class="nav-item">
                <a class="nav-link {{request()->routeIs('experience.index') ? 'active' : 'text-secondary'}} "
